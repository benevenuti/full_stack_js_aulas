...
Model.prototype.init = function () {
    // instancia o socket
    this.socket = io('http://sharpgame.herokuapp.com/');
...
Model.prototype.userConnected = function () {
    ...
    console.log(this)
    // dispara o evento de usuario conectado
